...
$.mask.masks = $.extend($.mask.masks, {
  ...
  'un-digito': {mask: '9'},
  'dos-digitos': {mask: '99'},
  'tres-digitos': {mask: '999'},
  'tres-digitos-default': {mask: '999', type: 'reverse', defaultValue: '0'},
  'cuatro-digitos': {mask : '9999'},
  'cinco-digitos': {mask: '99999'},
  'seis-digitos': {mask: '999999'},
  'siete-digitos': {mask: '9999999'},
  'ocho-digitos': {mask: '99999999'},
  'nueve-digitos': {mask: '999999999'},
  'diez-digitos': {mask : '9999999999'},
 ...
 $.validator.addMethod('siguiente', function(value, element, params) {
  ...
  $.validator.addMethod('valor-simple', function(value, element, params) {
	...
	$.validator.addMethod('contiene-a', function(value, element, params) {
      ...
      return 'El valor '+ janal.parser(element)+ ' no se encuentra en '+ params.valores+ '.';
    });
	...
	$.validator.addMethod('menor-a', function(value, element, params) {
      ...
      return 'El valor '+ janal.parser(element)+ ' debe ser menor o igual '+ janal.value(janal.cross($(element).attr('id'), params.cual))+ '.';
    });
  ...
  $.validator.addMethod(
	...
	$.validator.addMethod('fecha', function(value, element, params) {
      ...
      'Formato de la fecha '+ janal.parser(element)+ ' es inv\u00E1lida, el formato es [dd/mm/yyyy].';
    });	
