...
public class Desglose extends Empleados implements Serializable {
  ...
  protected void toAddTitulosEmpleado() throws Exception {
    ...
    this.addCell(this.posicionColumna+ 1, this.posicionFila, "CONTRATO", Alignment.CENTRE, Colour.YELLOW, Colour.BLACK, Boolean.FALSE);
    this.addCell(this.posicionColumna+ 2, this.posicionFila, "CLAVE", Alignment.CENTRE, Colour.YELLOW, Colour.BLACK, Boolean.FALSE);
    this.addCell(this.posicionColumna+ 3, this.posicionFila, "CATEGORIA", Alignment.CENTRE, Colour.YELLOW, Colour.BLACK, Boolean.FALSE);
    ...
    this.addCell(this.posicionColumna+ 15, this.posicionFila, "CAJA CHICA", Alignment.CENTRE, Colour.YELLOW, Colour.BLACK, Boolean.FALSE);
    this.addCell(this.posicionColumna+ 16, this.posicionFila, "SUELDO", Alignment.CENTRE, Colour.YELLOW, Colour.BLACK, Boolean.FALSE);
  }
  ...
  public void toEmpleado(Entity item, Double cajaChica) throws Exception {
    ...
    try {      
      ...
      this.addCell(this.posicionColumna+ 1, this.posicionFila, item.toString("contrato"));
      this.addCell(this.posicionColumna+ 2, this.posicionFila, item.toString("clave"));
      this.addCell(this.posicionColumna+ 3, this.posicionFila, item.toString("puesto"));
      ...
      this.addNumber(this.posicionColumna+ 15, this.posicionFila, Numero.toRedondearSat(cajaChica), this.value); 
      this.addNumber(this.posicionColumna+ 16, this.posicionFila, Numero.toRedondearSat(item.toDouble("neto")+ cajaChica), this.number);
  ...
  protected void toAddSubtotalesEmpleado(String desarrollo) throws Exception {
    ...
    this.addNumber(this.posicionColumna+ 15, this.posicionFila, Numero.toRedondearSat(this.subTotales.get("cajaChica")), this.total); 
  ...
  public void toProveedor(Entity item) throws Exception {
    try {      
      ...
      this.addCell(this.posicionColumna+ 1, this.posicionFila, item.toString("contrato"));
      this.addCell(this.posicionColumna+ 2, this.posicionFila, item.toString("clave"));
      this.addCell(this.posicionColumna+ 3, this.posicionFila, "SUB CONTRATISTA");
      this.addCell(this.posicionColumna+ 4, this.posicionFila, item.toString("departamento"));
      this.addCell(this.posicionColumna+ 5, this.posicionFila, item.toString("nombre"));
