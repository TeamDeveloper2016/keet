...
@Named(value = "keetControlesRechazos")
@ViewScoped
public class Rechazos extends IBaseFilterMultiple implements Serializable {

	private static final long serialVersionUID = 154600879172477098L;
  ...
  public void doLoad() {
    ...
    try {      			
      ...
      columns.add(new Columna("factor", EFormatoDinamicos.NUMERO_SIN_DECIMALES));                  
	    this.lazyModel= new FormatLazyModel("VistaCapturaDestajosDto", "puntosRechazosResidentes", params, columns);			
	...
	protected Revision toLoadRevision() {
