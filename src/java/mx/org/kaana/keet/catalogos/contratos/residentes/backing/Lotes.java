...
@Named(value = "keetCatalogosContratosResidentesLotes")
@ViewScoped
  ...
  public void doLoad() {
    ...
    try {      
      ...
      columns.add(new Columna("termino", EFormatoDinamicos.FECHA_CORTA));                  
	    this.lotes= DaoFactory.getInstance().toEntitySet("TcKeetContratosLotesDto", "byContratoResidentes", this.attrs);			
