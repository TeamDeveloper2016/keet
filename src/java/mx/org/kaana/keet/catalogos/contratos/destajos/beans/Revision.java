...
public class Revision implements Serializable{
	...
	public Revision(Long idFigura, Long tipo, Long idEstacion, Entity[] puntosRevision, String latitud, String longitud, Double metros, Long idContratoLote, String clave, Long idDepartamento) {
		this(idFigura, tipo, idEstacion, puntosRevision, latitud, longitud, metros, idContratoLote, "", clave, idDepartamento);
	}
	
	public Revision(Long idFigura, Long tipo, Long idEstacion, Entity[] puntosRevision, String latitud, String longitud, Double metros, Long idContratoLote, String observaciones, String clave, Long idDepartamento) {
