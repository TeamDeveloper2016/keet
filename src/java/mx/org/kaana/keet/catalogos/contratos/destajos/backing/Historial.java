...
public class Historial extends IBaseReporteDestajos implements Serializable {
  ...
  protected void init() {		
    ...
    try {
      ...
      this.fields = new ArrayList<>();
			opcion      = EOpcionesResidente.HISTORIAL; // (EOpcionesResidente)JsfBase.getFlashAttribute("opcionResidente");
			idDesarrollo= 1L; // (Long)JsfBase.getFlashAttribute("idDesarrollo");			
  ...
  public void doLoad() {
    ...
    try {
      ...
      this.fields.add(new Lote("Costo", "valor", "", "janal-column-right MarAuto Responsive janal-wid-6"));
      ...
      // this.fields.add(new Lote("registro", "registro"));
