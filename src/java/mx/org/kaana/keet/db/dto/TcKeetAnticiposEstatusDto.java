...
@Entity
@Table(name="tc_keet_anticipos_estatus")
public class TcKeetAnticiposEstatusDto implements IBaseDto, Serializable {
  ...
  public TcKeetAnticiposEstatusDto() {
    this(new Long(-1L));
  }

  public TcKeetAnticiposEstatusDto(Long key) {
    this(null, new Long(-1L), null, null, null);
    setKey(key);
  }

  public TcKeetAnticiposEstatusDto(String descripcion, Long idAnticipoEstatus, Long idJustificacion, String estatusAsociados, String nombre) {
  ...
  @Override
  public Long getKey() {
  	return getIdAnticipoEstatus();
  }

  @Override
  public void setKey(Long key) {
  	this.idAnticipoEstatus = key;
  }
  ...
  public Object[] toArray() {
    ...
    getDescripcion(), getIdAnticipoEstatus(), getIdJustificacion(), getEstatusAsociados(), getNombre(), getRegistro()
    };
    return regresar;
  }
  ...
  public String toAllKeys() {
    StringBuilder regresar= new StringBuilder();
    regresar.append("|");
    regresar.append("idAnticipoEstatus~");
    regresar.append(getIdAnticipoEstatus());
    regresar.append("|");
    return regresar.toString();
  }
  ...
  public Class toHbmClass() {
    return TcKeetAnticiposEstatusDto.class;
  }

  @Override
  public boolean isValid() {
  	return getIdAnticipoEstatus()!= null && getIdAnticipoEstatus()!=-1L;
  }
  ...
  public boolean equals(Object obj) {
    ...
    final TcKeetAnticiposEstatusDto other = (TcKeetAnticiposEstatusDto) obj;
    if (getIdAnticipoEstatus() != other.idAnticipoEstatus && (getIdAnticipoEstatus() == null || !getIdAnticipoEstatus().equals(other.idAnticipoEstatus))) {
      return false;
    }
    return true;
  }
  ...
  public int hashCode() {
    int hash = 7;
    hash = 67 * hash + (getIdAnticipoEstatus() != null ? getIdAnticipoEstatus().hashCode() : 0);
    return hash;
  }
