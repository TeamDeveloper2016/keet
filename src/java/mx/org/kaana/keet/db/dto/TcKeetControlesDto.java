...
@Entity
@Table(name="tc_keet_controles")
public class TcKeetControlesDto implements IBaseDto, Serializable, Cloneable {
  ...
  public TcKeetControlesDto() {
    this(new Long(-1L));
  }

  public TcKeetControlesDto(Long key) {
  ...
  public Class toHbmClass() {
    return TcKeetControlesDto.class;
  }

  @Override
  public boolean isValid() {
  	return getIdControl()!= null && getIdControl()!=-1L;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (getIdControl() != other.idControl && (getIdControl() == null || !getIdControl().equals(other.idControl))) {
      return false;
    }
    return true;
  }
