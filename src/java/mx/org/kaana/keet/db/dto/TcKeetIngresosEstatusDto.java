...
@Entity
@Table(name="tc_keet_ingresos_estatus")
public class TcKeetIngresosEstatusDto implements IBaseDto, Serializable {
  ...
  public TcKeetIngresosEstatusDto() {
    this(new Long(-1L));
  }

  public TcKeetIngresosEstatusDto(Long key) {
    this(null, new Long(-1L), null, null, null);
    setKey(key);
  }

  public TcKeetIngresosEstatusDto(String descripcion, Long idIngresoEstatus, Long idJustificacion, String estatusAsociados, String nombre) {
  ...
  @Override
  public Long getKey() {
  	return getIdIngresoEstatus();
  }

  @Override
  public void setKey(Long key) {
  	this.idIngresoEstatus = key;
  }
  ...
  public Object[] toArray() {
    ...
    getDescripcion(), getIdIngresoEstatus(), getIdJustificacion(), getEstatusAsociados(), getNombre(), getRegistro()
    };
    return regresar;
  }
  ...
  public String toAllKeys() {
    StringBuilder regresar= new StringBuilder();
    regresar.append("|");
    regresar.append("idIngresoEstatus~");
    regresar.append(getIdIngresoEstatus());
    regresar.append("|");
    return regresar.toString();
  }
  ...
  public Class toHbmClass() {
    return TcKeetIngresosEstatusDto.class;
  }

  @Override
  public boolean isValid() {
  	return getIdIngresoEstatus()!= null && getIdIngresoEstatus()!=-1L;
  }
  ...
  public boolean equals(Object obj) {
    ...
    final TcKeetIngresosEstatusDto other = (TcKeetIngresosEstatusDto) obj;
    if (getIdIngresoEstatus() != other.idIngresoEstatus && (getIdIngresoEstatus() == null || !getIdIngresoEstatus().equals(other.idIngresoEstatus))) {
      return false;
    }
    return true;
  }
  ...
  public int hashCode() {
    int hash = 7;
    hash = 67 * hash + (getIdIngresoEstatus() != null ? getIdIngresoEstatus().hashCode() : 0);
    return hash;
  }
