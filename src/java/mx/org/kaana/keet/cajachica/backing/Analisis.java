			...
			if(this.lazy!= null && !this.lazy.isEmpty()) {
				...
				if("costo".equals((String)this.attrs.get("campo"))) {
  				...
  				model.toCustomFormatLabel("function (params) {return jsEcharts.format(params, 'double');}");
					model.getTooltip().setFormatter("function (params) {return jsEcharts.tooltip(params, 'double', 'mayusculas');}");
				} // else	
				model.getLegend().setFormatter("function (params) {return jsEcharts.legend(params, 'mayusculas');}");
