...
public class Estaciones extends Maestro implements IArbol, Serializable {
  ...
  private Session sesion;
	...
	public Estaciones(Session sesion) {
      ...
      new Detalle(4, 3, 2, "0", "[1..999]",  "", "Lote"),  // 4to nivel campo de orden de la tabla de contratos_lotes a 3 digitos para el caso de las plantillas se va a tener el id_prototipo a 3 dígitos
