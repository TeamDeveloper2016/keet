...
public class FormatCustomModel extends FormatLazyModel<IBaseDto> {

  private static final Log LOG = LogFactory.getLog(FormatCustomModel.class);
	private static final long serialVersionUID=-6690889390042439951L;

  private EFiltersWith like;

  public FormatCustomModel(String proceso, Map<String, Object> params, List<Columna> columns) {
    this(proceso, "lazy", params, columns,-1L);
  }
	
  public FormatCustomModel(String proceso, Map<String, Object> params, List<Columna> columns, Long idFuenteDato) {
    this(proceso, "lazy", params, columns,idFuenteDato);
  }

  public FormatCustomModel(String proceso, String idXml, Map<String, Object> params, List<Columna> columns) {
    this(proceso, idXml, params, columns, EFiltersWith.START_WITH,-1L);
  }
	
	public FormatCustomModel(String proceso, String idXml, Map<String, Object> params, List<Columna> columns, Long idFuenteDato) {
    this(proceso, idXml, params, columns, EFiltersWith.START_WITH);
  }

  public FormatCustomModel(String proceso, String idXml, Map<String, Object> params, List<Columna> columns, EFiltersWith like) {
    this(proceso, idXml, params, columns, like,-1L);
  }

	
	public FormatCustomModel(String proceso, String idXml, Map<String, Object> params, List<Columna> columns, EFiltersWith like, Long idFuenteDato) {
