...
public class TrJanalMenusPerfilesDto implements IBaseDto, Serializable {
  ...
  public TrJanalMenusPerfilesDto() {
    this(new Long(-1L));
  }

  public TrJanalMenusPerfilesDto(Long key) {
    this(null, null, null, null);
    setKey(key);
  }

  public TrJanalMenusPerfilesDto(Long idPerfil, Long idUsuario, Long idMenuGrupo, Long idMenuPerfil) {
  ...
  public Class toHbmClass() {
    return TrJanalMenusPerfilesDto.class;
  }
  ...
  public boolean equals(Object obj) {
    ...
    final TrJanalMenusPerfilesDto other = (TrJanalMenusPerfilesDto) obj;
