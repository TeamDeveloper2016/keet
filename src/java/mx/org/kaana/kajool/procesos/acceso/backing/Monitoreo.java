...
@Named(value = "kajoolMonitoreo")
@ViewScoped
public class Monitoreo extends Respaldos implements Serializable {

  private static final long serialVersionUID= 5323749709626263808L;
  private static final Log LOG              = LogFactory.getLog(Monitoreo.class);
