...
import mx.org.kaana.kajool.procesos.mantenimiento.configuracion.reglas.Transaccion;


@Named(value = "kajoolMantenimientoConfiguracionEmpresa")
@ViewScoped
public class Empresa extends IBaseFilter implements Serializable {
