...
//	
  ...
  public void doNotificar() {
		...
		try {
			params.put("header", "...");
			params.put("footer", "...");
			params.put("empresa", "Instituto Desarrollo de Software Libre");
			...
			for (String item: correos) {
				...
				try {
					...
					files.add(user);
					IBaseAttachment notificar= new IBaseAttachment(ECorreos.FACTURACION, "jimenez76@yahoo.com", item, "Invitación al evento de KAANA", params, files);
