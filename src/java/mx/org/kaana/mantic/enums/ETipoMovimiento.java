...
public enum ETipoMovimiento {
	...
	COMBUSTIBLES("combustible(s)", "tc_mantic_transferencias", "idCombustible", "VistaCombustiblesDto"),
	SUMINISTROS("suministro(s)", "tc_sakbe_suministros", "idSuministro", "VistaSuministrosDto");
