...
public enum EReportes implements IReportAttribute {
  ...
  PAGOS_CUENTAS_POR_COBRAR  ("VistaClientesDto", "pagosCuentasCobrar", "Pagos a cuentas por cobrar", "/Paginas/Mantic/Catalogos/Clientes/Cuentas/Reportes/cuentasPorCobrar", EFormatos.PDF, "pagos_cuentas_por_cobrar", "/Paginas/Mantic/Catalogos/Clientes/Cuentas/saldos"),
  DEUDAS_CLIENTES           ("VistaDeudasClienteDto", "row", "Estado de cuenta", "/Paginas/Mantic/Catalogos/Clientes/Cuentas/Reportes/estadoDeCuenta", EFormatos.PDF, "estado_cuenta_cliente", "/Paginas/Mantic/Catalogos/Clientes/Cuentas/saldos"),
  CLIENTE_ESTADO_CUENTA     ("VistaDeudasClienteDto", "estadoDeCuenta", "Estado de cuenta", "/Paginas/Mantic/Catalogos/Clientes/Cuentas/Reportes/estadoDeCuenta", EFormatos.PDF, "estado_cuenta_cliente", "/Paginas/Mantic/Catalogos/Clientes/Cuentas/saldos"),  
  DEUDAS_CLIENTES_PENDIENTES("VistaDeudasClienteDto", "pendientes", "Estado de cuenta", "/Paginas/Mantic/Catalogos/Clientes/Cuentas/Reportes/clienteDeudasDetalle", EFormatos.PDF, "estado_cuenta_cliente", "/Paginas/Mantic/Catalogos/Clientes/Cuentas/saldos"),
  ...
  COMPLEMENTOS_PAGO         ("VistaFicticiasDto", "lazy", "Listado de complementos de pagos", "/Paginas/Mantic/Facturas/Reportes/complementos", EFormatos.PDF, "listado_de_complementos_pago", "/Paginas/Mantic/Facturas/filtro"),
	...
	ANTICIPOS                 ("VistaAnticiposDto", "lazy", "Anticipos", "/Paginas/Keet/Prestamos/Proveedor/Reportes/prestamos", EFormatos.PDF, "anticipos", "Paginas/Keet/Prestamos/Proveedor/filtro"),
	...
	ANTICIPOS_PAGOS           ("VistaReportesAnticiposDto", "anticiposPagos", "Resumen de pagos de anticipos", "/Paginas/Keet/Prestamos/Proveedor/Reportes/pagosPrestamos", EFormatos.PDF, "pagos_anticipo", "/Paginas/Keet/Prestamos/Proveedor/filtro"),
	RESUMEN_PRESTAMOS         ("VistaReportesPrestamosDto", "resumenPrestamos", "Resumen de los préstamos", "/Paginas/Keet/Prestamos/Reportes/resumenPrestamos", EFormatos.PDF, "resumen_prestamos", "/Paginas/Keet/Prestamos/filtro"),
	RESUMEN_ANTICIPOS         ("VistaReportesAnticiposDto", "resumenAnticipos", "Resumen de los anticipos", "/Paginas/Keet/Prestamos/Proveedor/Reportes/resumenPrestamos", EFormatos.PDF, "resumen_anticipos", "/Paginas/Keet/Prestamos/Proveedor/filtro"),
	NOMINA_SUBCONTRATISTA     ("VistaNominaReportesDto", "proveedorDetalle", "Detalle de nómina del subcontratista", "/Paginas/Keet/Nominas/Reportes/detalleSubcontratista", EFormatos.PDF, "detalle_nomina_subcontratista", "/Paginas/Keet/Nominas/filtro"),
  ...
  DESTAJOS_CAT_SUBCONTRATISTA("VistaNominaConsultasDto", "destajoProveedor", "Destajos del subcontratista", "/Paginas/Keet/Catalogos/Contratos/Destajos/Reportes/detallesProveedor", EFormatos.PDF, "destajos_subcontratista", "/Paginas/Keet/Catalogos/Contratos/Destajos/filtro"),
  DESTAJOS_TOTALES_SUBCONTRATISTA("VistaNominaConsultasReportesDto", "destajoProveedor", "Destajos del subcontratista", "/Paginas/Keet/Catalogos/Contratos/Destajos/Reportes/destajosProveedor", EFormatos.PDF, "destajos_subcontratista_desarrollos", "/Paginas/Keet/Catalogos/Contratos/Destajos/filtro"),
  ...
  ESTACIONES                ("VistaReportesEstacionesDto", "estaciones", "Estaciones", "/Paginas/Keet/Estaciones/Reportes/estaciones", EFormatos.PDF, "estaciones", "/Paginas/Keet/Estaciones/contrato"),
  ...
  CONTRATO_RESUMEN          ("VistaContratosDto", "findDesarrollo", "Resumen de estimación de obra", "/Paginas/Contenedor/Reportes/resumen", EFormatos.PDF, "resumen", "/Paginas/Contenedor/resumen");
