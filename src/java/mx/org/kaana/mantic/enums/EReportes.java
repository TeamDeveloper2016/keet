...
public enum EReportes implements IReportAttribute{
  ...
  DETALLE_NOMINA_PERSONAS   ("VistaNominaConsultasDto", "personas", "Detalle de nómina", "/Paginas/Keet/Nominas/Reportes/detallePersona", EFormatos.PDF, "detalle_nomina_persona", "/Paginas/Keet/Nominas/filtro"),
  LISTADO_NOMINA_PERSONAS   ("VistaNominaConsultasDto", "personas", "Listado nómina contratistas", "/Paginas/Keet/Nominas/Reportes/personas", EFormatos.PDF, "listado_nomina_contratistas", "/Paginas/Keet/Nominas/personas"),
