    ...
    super.afterDetailEval();
     ...
     BitMatrix matrix         = null;
      try {
        ...
        matrix = writer.encode(getParameterValue("NOMBRE_REPORTE").toString().concat(":").concat(getFieldValue("CONSECUTIVO").toString()).toString().concat("-").concat("http://cafu.jvmhost.net/KEET/"), BarcodeFormat.QR_CODE, 400, 400, hints);
