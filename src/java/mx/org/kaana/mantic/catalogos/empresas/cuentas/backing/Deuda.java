...
public class Deuda extends IBaseFilter implements Serializable {
  ...
  private static final Log LOG = LogFactory.getLog(Deuda.class);
	...
	private LocalDate fechaPagoGeneral;
	private LocalDate fechaPagoSegmento;
  ...
  public LocalDate getFechaPagoGeneral() {
    return fechaPagoGeneral;
  }

  public void setFechaPagoGeneral(LocalDate fechaPagoGeneral) {
    this.fechaPagoGeneral = fechaPagoGeneral;
  }

  public LocalDate getFechaPagoSegmento() {
    return fechaPagoSegmento;
  }

  public void setFechaPagoSegmento(LocalDate fechaPagoSegmento) {
    this.fechaPagoSegmento = fechaPagoSegmento;
  }
  ...
  protected void init() {
    ...
    try {			
      ...
      this.attrs.put("idEmpresaDeuda", JsfBase.getFlashAttribute("idEmpresaDeuda"));     
			...
			this.fechaPagoGeneral= LocalDate.now();
			this.fechaPagoSegmento= LocalDate.now();
  ...
  public void doLoad() {
	...
	public void doRegistrarPagoGeneral() {
        ...
        pago.setFechaPago(this.fechaPagoGeneral);
	...
	public void doRegistrarPagoSegmento() {
        ...
        pago.setFechaPago(this.fechaPagoSegmento);
