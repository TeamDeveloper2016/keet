	...
	public void doEliminarProveedorDepartamento(){
		try {			
			if(this.proveedoresDepartamentos.remove(this.proveedorDepartamentoSeleccion)){
				...
				JsfBase.addMessage("No fue porsible eliminar el departamento", ETipoMensaje.INFORMACION);
		} // try
		catch (Exception e) {
			Error.mensaje(e);
			JsfBase.addMessageError(e);			
	...
	public void doEliminarFamilia() {
		try {
			if(this.proveedoresFamilias.remove(this.proveedorFamilia)) {
				...
				JsfBase.addMessage("No fue porsible eliminar la familia seleccionada", ETipoMensaje.INFORMACION);
		} // try
		catch (Exception e) {
			Error.mensaje(e);
			JsfBase.addMessageError(e);			
