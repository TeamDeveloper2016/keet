...
public enum ECargaMasiva implements Serializable {
	...
	ESTACIONES(9L, "MANZANA|LOTE|CODIGO|NOMBRE|CANTIDAD|COSTOS/IVA|UNIDADMEDIDA", "MANZANA,LOTE,CODIGO,NOMBRE,CANTIDAD,COSTO S/IVA,UNIDAD MEDIDA", 7, 500, "masivo-estaciones.xls");
