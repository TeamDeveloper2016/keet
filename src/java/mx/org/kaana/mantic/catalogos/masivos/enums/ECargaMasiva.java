...
public enum ECargaMasiva implements Serializable {
	...
	CODIGOS(8L, "PROVEEDOR|CODIGOPROPIO|CODIGOPROVEEDOR", "PROVEEDOR,CODIGO PROPIO,CODIGO PROVEEDOR", 3, 500, "masivo-codigos.xls"),
	ESTACIONES(9L, "MANZANA|LOTE|CODIGO|NOMBRE|CANTIDAD|COSTOS/IVA|UNIDADMEDIDA|INICIO|TERMINO", "MANZANA,LOTE,CODIGO,NOMBRE,CANTIDAD,COSTO S/IVA,UNIDAD MEDIDA,INICIO,TERMINO", 9, 500, "masivo-estaciones.xls"),
	PERSONAL(10L, "CLAVE|NOMBRE|ACTIVO|SUELDO|REINGRESO/BAJA|PUESTO|DEPARTAMENTO|CONTRATISTA", "CLAVE,NOMBRE,ACTIVO,SUELDO,REINGRESO/BAJA,PUESTO,DEPARTAMENTO,CONTRATISTA", 7, 500, "masivo-personal.xls");
