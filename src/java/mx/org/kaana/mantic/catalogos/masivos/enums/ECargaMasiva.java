...
public enum ECargaMasiva implements Serializable {
	...
	ESTACIONES(1L, "MANZANA|LOTE|CODIGO|NOMBRE|CANTIDAD|COSTOS/IVA|UNIDADMEDIDA", "MANZANA,LOTE,CODIGO,NOMBRE,CANTIDAD,COSTO S/IVA,UNIDAD MEDIDA", 7, 100, "masivo-estaciones.xls");
