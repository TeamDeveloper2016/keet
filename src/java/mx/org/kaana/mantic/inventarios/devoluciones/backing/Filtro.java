...
public class Filtro extends IBaseFilter implements Serializable {
  ...
  public void doEliminar() {
    ...
    try {
      ...
      this.attrs.put("proveedores", (List<UISelectEntity>) UIEntity.seleccione("VistaDevolucionesDto", "proveedores", params, columns, "nombre"));
			this.attrs.put("idProveedor", new UISelectEntity("-1"));
			columns.remove(0);
      this.attrs.put("catalogo", (List<UISelectEntity>) UIEntity.seleccione("TcManticDevolucionesEstatusDto", "row", params, columns, "nombre"));
