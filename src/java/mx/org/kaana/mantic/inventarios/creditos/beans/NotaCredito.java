...
public class NotaCredito extends TcManticCreditosNotasDto implements Serializable {
    ...
    super(idProveedor, idNotaEntrada, importe, ejercicio, consecutivo, idCreditoEstatus, idTipoCreditoNota, idDevolucion, idUsuario, folio, observaciones, idEmpresa, orden, idCreditoNota, LocalDate.now(), saldo);
