...
@Entity
@Table(name="tc_mantic_egresos_estatus")
public class TcManticEgresosEstatusDto implements IBaseDto, Serializable {
  ...
  public TcManticEgresosEstatusDto() {
    this(new Long(-1L));
  }

  public TcManticEgresosEstatusDto(Long key) {
    this(null, new Long(-1L), null, null, null);
    setKey(key);
  }

  public TcManticEgresosEstatusDto(String descripcion, Long idEgresoEstatus, Long idJustificacion, String estatusAsociados, String nombre) {
  ...
  @Override
  public Long getKey() {
  	return getIdEgresoEstatus();
  }

  @Override
  public void setKey(Long key) {
  	this.idEgresoEstatus = key;
  }
  ...
  public Object[] toArray() {
    ...
    getDescripcion(), getIdEgresoEstatus(), getIdJustificacion(), getEstatusAsociados(), getNombre(), getRegistro()
    };
    return regresar;
  }
  ...
  public String toAllKeys() {
    StringBuilder regresar= new StringBuilder();
    regresar.append("|");
    regresar.append("idEgresoEstatus~");
    regresar.append(getIdEgresoEstatus());
    regresar.append("|");
    return regresar.toString();
  }
  ...
  public Class toHbmClass() {
    return TcManticEgresosEstatusDto.class;
  }

  @Override
  public boolean isValid() {
  	return getIdEgresoEstatus()!= null && getIdEgresoEstatus()!=-1L;
  }
  ...
  public boolean equals(Object obj) {
    ...
    final TcManticEgresosEstatusDto other = (TcManticEgresosEstatusDto) obj;
    if (getIdEgresoEstatus() != other.idEgresoEstatus && (getIdEgresoEstatus() == null || !getIdEgresoEstatus().equals(other.idEgresoEstatus))) {
      return false;
    }
    return true;
  }
  ...
  public int hashCode() {
    int hash = 7;
    hash = 67 * hash + (getIdEgresoEstatus() != null ? getIdEgresoEstatus().hashCode() : 0);
    return hash;
  }
