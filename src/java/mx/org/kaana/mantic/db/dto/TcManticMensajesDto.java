...
public class TcManticMensajesDto implements IBaseDto, Serializable {
  ...
  public TcManticMensajesDto(Long key) {
    this(null, null, null, LocalDateTime.now(), null, null, null, null, LocalDateTime.now(), null, new Long(-1L), null, null, null, null, null, null, null, null);
    setKey(key);
  }

  public TcManticMensajesDto(String retentionPolicy, Long idSendStatus, String device, LocalDateTime created, String webhookStatus, String waId, String message, String priority, LocalDateTime deliver, String wid, Long idMensaje, String phone, Long idTipoMensaje, String sendStatus, String id, String deliveryStatus, String status, Long idUsuario, String telefono) {
