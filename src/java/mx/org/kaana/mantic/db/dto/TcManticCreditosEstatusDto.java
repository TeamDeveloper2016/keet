...
@Entity
@Table(name="tc_mantic_creditos_estatus")
public class TcManticCreditosEstatusDto implements IBaseDto, Serializable {
  ...
  public TcManticCreditosEstatusDto() {
    this(new Long(-1L));
  }

  public TcManticCreditosEstatusDto(Long key) {
    this(new Long(-1L), null, null, null, null);
    setKey(key);
  }

  public TcManticCreditosEstatusDto(Long idCreditoEstatus, Long idJustificacion, String estatusAsociados, String decripcion, String nombre) {
  ...
  public Object[] toArray() {
    ...
    getIdCreditoEstatus(), getIdJustificacion(), getEstatusAsociados(), getDecripcion(), getNombre(), getRegistro()
    };
    return regresar;
  }
  ...
  public Class toHbmClass() {
    return TcManticCreditosEstatusDto.class;
  }
  ...
  public boolean equals(Object obj) {
    ...
    final TcManticCreditosEstatusDto other = (TcManticCreditosEstatusDto) obj;
